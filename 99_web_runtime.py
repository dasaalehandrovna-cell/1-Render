...
STARTUP_RELEASE_SUMMARY = (
    '• ⚡ Пер-R29: скорость R28 защищена — обычный handler напрямую вызывает Telegram edit без WINDOW_RENDER очереди; директивный режим блокирует смену бизнес-логики; Google работает в одном окне; Инфо сгруппировано; добавлены переключатели пересланных/других ботов.\n'
...
def main():
    ...
    db_detail = (f'Пер-R29 split authoritative revision={_split_preboot_revision_r19 or "unknown"}' if _split_preboot_authoritative_r19 else '')
