...
STARTUP_RELEASE_SUMMARY = (
    '• ⚡ Пер-R27: кнопки имеют приоритет над housekeeping; служебная revision больше не пишет SQLite в callback; delta/full snapshot выполняется только после тишины; «Назад» сначала возвращает предыдущее окно.\n'
...
def main():
    ...
    db_detail = (f'Пер-R27 split authoritative revision={_split_preboot_revision_r19 or "unknown"}' if _split_preboot_authoritative_r19 else '')
