...
STARTUP_RELEASE_SUMMARY = (
    '• ⚡ Пер-R28: отрисовка возвращена к прямому пути выс-262 — handler сразу вызывает Telegram edit без WINDOW_RENDER очереди; HEAVY/continuity/snapshot работают только после UI и тишины; «Назад» возвращает предыдущее окно.\n'
...
def main():
    ...
    db_detail = (f'Пер-R28 split authoritative revision={_split_preboot_revision_r19 or "unknown"}' if _split_preboot_authoritative_r19 else '')
