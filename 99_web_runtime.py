...
STARTUP_RELEASE_SUMMARY = (
    '• 🛰 Пер-R40: тяжёлые file jobs запускаются асинхронно — FAST не держит единственный export-worker, а лёгкий supervisor ждёт реальную доставку.\n'
...
def main():
    ...
    db_detail = (f'Пер-R40 split authoritative revision={_split_preboot_revision_r19 or "unknown"}' if _split_preboot_authoritative_r19 else '')
