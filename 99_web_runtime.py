...
STARTUP_RELEASE_SUMMARY = (
    '• ⚡ Пер-R32: скорость R28/R29 защищена; Info-меню имеет три режима — Новое / Старое / Третий вариант.\n'
    '• 🧩 R32 EVENT STREAM: обычные full SQLite каждые 5 минут отключены; HEAVY получает только точечные изменения и сам собирает restore-базу.\n'
...
def main():
    ...
    db_detail = (f'Пер-R32 split authoritative revision={_split_preboot_revision_r19 or "unknown"}' if _split_preboot_authoritative_r19 else '')
