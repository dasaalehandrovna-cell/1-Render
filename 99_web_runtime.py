...
STARTUP_RELEASE_SUMMARY = (
    '• ⚡ Пер-R30: скорость R28/R29 защищена; Info-меню имеет сохраняемый переключатель Новое/Старое; директивный режим, однооконный Google и источники сообщений сохранены.\n'
...
def main():
    ...
    db_detail = (f'Пер-R30 split authoritative revision={_split_preboot_revision_r19 or "unknown"}' if _split_preboot_authoritative_r19 else '')
