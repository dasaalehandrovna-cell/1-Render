...
STARTUP_RELEASE_SUMMARY = (
    '• ⚡ Пер-R31: скорость R28/R29 защищена; Info-меню имеет три режима — Новое / Старое / Третий вариант.\n'
...
def main():
    ...
    db_detail = (f'Пер-R31 split authoritative revision={_split_preboot_revision_r19 or "unknown"}' if _split_preboot_authoritative_r19 else '')
