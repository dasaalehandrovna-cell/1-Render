...
STARTUP_RELEASE_SUMMARY = (
    '• ⚡ Пер-R33: скорость R28/R29 защищена; Info-меню имеет три режима — Новое / Старое / Третий вариант.\n'
    '• 🧩 R33 HEAVY: регулярные full SQLite отключены; файлы, таблицы, журналы, документы, большие выборки, MEGA/Google и полное состояние выполняются на Render #2.\n'
...
def main():
    ...
    db_detail = (f'Пер-R33 split authoritative revision={_split_preboot_revision_r19 or "unknown"}' if _split_preboot_authoritative_r19 else '')
