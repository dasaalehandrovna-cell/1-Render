...
# R68 CLEAN DEPLOY ROOT: explicit allowlist. Never COPY the whole repository.
...
RUN B_T=123456:STARTUPSMOKE DB_FILE=/tmp/r68_build_smoke.sqlite3 \
 ...
 && rm -f /tmp/r68_build_smoke.sqlite3 /tmp/r68_build_smoke.sqlite3-wal /tmp/r68_build_smoke.sqlite3-shm
