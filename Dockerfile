...
RUN B_T=123456:STARTUPSMOKE DB_FILE=/tmp/r70_build_smoke.sqlite3 \
 ...
 && rm -f /tmp/r70_build_smoke.sqlite3 /tmp/r70_build_smoke.sqlite3-wal /tmp/r70_build_smoke.sqlite3-shm
