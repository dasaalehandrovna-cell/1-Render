...
# R51 FINAL CLEAN BUILD: explicit allowlist. Never COPY the whole repository.
...
RUN B_T=123456:STARTUPSMOKE DB_FILE=/tmp/r51_build_smoke.sqlite3 \
 ...
 && rm -f /tmp/r51_build_smoke.sqlite3 /tmp/r51_build_smoke.sqlite3-wal /tmp/r51_build_smoke.sqlite3-shm
