...
def _runtime_contract_gate_v222() -> None:
    contracts = {
        ...
        "submit_interactive_file_job": ({"chat_id", "kind", "label", "func"}, "100_r33_heavy_offload.py"),
    }
    problems=[]
