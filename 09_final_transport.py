...
def _final_bot_identity_text(value):
    ...
    raw = str(value or '')
    try:
        name = str(globals().get('BOT_DISPLAY_NAME') or 'очнись_11.1')
